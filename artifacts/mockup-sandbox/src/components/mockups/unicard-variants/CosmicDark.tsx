...
export function CosmicDark() {
  return (
    <div className="min-h-screen relative overflow-hidden text-slate-50 font-sans" style={{ background: '#050d1a' }}>
      {/* Background Effects */}
      <div className="absolute inset-0 star-field pointer-events-none" />
      <img src="/__mockup/images/bg-aurora.png" className="absolute inset-0 w-full h-full object-cover opacity-8 mix-blend-screen pointer-events-none" alt="aurora bg" />
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/5 py-4 px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center shadow-[0_0_15px_rgba(0,180,216,0.5)]">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="md:hidden glass-card p-2 text-white bg-transparent border-white/10"><Menu className="w-5 h-5" /></Button>
        </div>
      </nav>

      <main className="relative z-10 container mx-auto px-4 pt-28 md:pt-32 pb-24">
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row items-center gap-12 max-w-6xl mx-auto mt-8 md:mt-12 mb-24">
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight chrome-text tracking-tight">
              Оплачивайте зарубежные сервисы без ограничений
            </h1>
            
            <p className="text-lg md:text-xl text-blue-200/80 mb-10 max-w-2xl font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Button size="lg" className="neon-btn border-0 rounded-full h-14 px-8 text-lg font-bold w-full sm:w-auto">
                Оформить карту
          ...
          <div className="flex-1 hidden md:flex justify-center">
            <img src="/__mockup/images/hero-card.png" className="w-full max-w-sm rounded-2xl shadow-[0_20px_50px_rgba(0,180,216,0.15)]" alt="ЮниКард" />
          </div>
        </section>

        {/* Trust Bar */}
        <section className="mb-24 flex flex-col items-center opacity-70">
          <p className="text-sm text-blue-300 mb-6 uppercase tracking-widest">Мы поддерживаем оплату</p>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            />
            <FeatureCard 
              icon={<Wallet className="w-8 h-8 text-cyan-300" />}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
            ...
            <ServiceCard 
              ...
              icon={<Gamepad2 className="w-10 h-10 text-blue-300" />}
            ...
            <ServiceCard 
              ...
              bgGradient="from-cyan-900/40 to-sky-900/40"
            />
          </div>
        </section>
      </main>
  ...
  return (
    <Card className={`glass-card border-white/10 p-8 flex items-center gap-6 group overflow-hidden relative bg-transparent text-white`}>
      ...
      <div className="relative z-10 flex-1">
        ...
        <p className="text-sm text-blue-200/70 group-hover:text-blue-100 transition-colors">{description}</p>
      </div>
