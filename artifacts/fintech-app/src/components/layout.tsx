  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="blob-1 absolute -top-40 -left-40 w-[700px] h-[700px] rounded-full bg-violet-600/30 blur-[100px]" />
        <div className="blob-2 absolute top-1/3 -right-40 w-[600px] h-[600px] rounded-full bg-blue-600/25 blur-[90px]" />
        <div className="blob-3 absolute -bottom-40 left-1/3 w-[600px] h-[600px] rounded-full bg-purple-700/25 blur-[100px]" />
        <div className="blob-1 absolute top-1/2 right-1/4 w-[400px] h-[400px] rounded-full bg-indigo-500/20 blur-[80px]" style={{ animationDuration: "26s", animationDelay: "-8s" }} />
        <div className="blob-2 absolute bottom-1/4 -left-20 w-[350px] h-[350px] rounded-full bg-fuchsia-600/20 blur-[80px]" style={{ animationDelay: "-12s" }} />
      </div>
